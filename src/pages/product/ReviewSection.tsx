...
import { MapReviewDiv, MapReviewInnerDiv, ReviewButton, ReviewContent, ReviewContentDiv, ReviewContentInput, ReviewDate, ReviewDiv, ReviewGroupName, ReviewInfo, UserIdInfo } from "./DetailSt";
